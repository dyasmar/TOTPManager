...
(function() {
    ...
    var E = E || {};
    E.scope = {};
    E.getGlobal = function(l) { return "undefined" != typeof window && window === l ? l : "undefined" != typeof global && null != global ? global : l };
    ...
    function P() {
        return function(l) {
            ...
            f.m = l;
            f.c = d;
            f.d = function(a, b, c) { f.o(a, b) || Object.defineProperty(a, b, { configurable: !1, enumerable: !0, get: c }) };
            f.n = function(a) {
                var b = a && a.__esModule ? function() { return a["default"] } : function() { return a };
                f.d(b, "a", b);
                return b
            };
            f.o = function(a, b) { return Object.prototype.hasOwnProperty.call(a, b) };
            f.p = "";
            return f(f.s = 6)
        }([function(l,
            f, d) {
            (function(a) {
                ...
                f.b = b;
                b.uint = {};
                b.uint.decode = function(a) { a = new Uint8Array(a); for (var b = 0, c = 0; c < a.length; c++) 0 !== a[c] && (b *= 256, b += a[c]); return b };
                b.uint.encode = function(a) { for (var b = new ArrayBuffer(8), c = new Uint8Array(b), e = 7; 0 <= e && 0 !== a; e--) c[e] = a & 255, a -= c[e], a /= 256; return b };
                b.raw = {};
                b.raw.decode = function(a) { a = new Uint8Array(a); for (var b = "", c = 0; c < a.length; c++) b += String.fromCharCode(a[c]); return b };
                ...
                b.hex.encode = function(a) { for (var b = new ArrayBuffer(a.length / 2), c = new Uint8Array(b), e = 0; e < c.length; e++) c[e] = parseInt(a.substr(2 * e, 2), 16); return b };
                var c = {};
                f.a = c;
            ...
            var b = d(0),
                c = d(4);
            a.fromRaw = function(a) { return new this({ buffer: b.b.raw.encode(a) }) };
            a.fromB32 = function(a) { return new this({ buffer: b.b.b32.encode(a) }) };
            a.fromHex = function(a) { return new this({ buffer: b.b.hex.encode(a) }) };
                ...
                raw: {
                    ...
                    get: function() {
                        Object.defineProperty(this,
                            "raw", { enumerable: !0, configurable: !0, writable: !0, value: b.b.raw.decode(this.buffer) });
                        return this.raw
                    }
                },
                b32: { configurable: !0, enumerable: !0, get: function() { Object.defineProperty(this, "b32", { enumerable: !0, configurable: !0, writable: !0, value: b.b.b32.decode(this.buffer) }); return this.b32 } },
                hex: { configurable: !0, enumerable: !0, get: function() { Object.defineProperty(this, "hex", { enumerable: !0, configurable: !0, writable: !0, value: b.b.hex.decode(this.buffer) }); return this.hex } }
            });
            f.a = a
        }, function(l, f, d) {
            function a(a) {
            ...
            b.prototype.generate = function(a) { a = void 0 === a ? {} : a; var c = void 0 === a.counter ? this.counter++ : a.counter; return b.generate({ secret: this.secret, algorithm: this.algorithm, digits: this.digits, counter: c, pad: a.pad }) };
            ...
            b.prototype.validate = function(a) { return b.validate({ token: a.token, secret: this.secret, algorithm: this.algorithm, counter: void 0 === a.counter ? this.counter : a.counter, window: a.window }) };
            b.prototype.toString = function() { return C.a.stringify(this) };
            f.a = b;
            a.generate = function(a) {
                ...
                return b.generate({ secret: c, algorithm: e, digits: d, counter: Math.floor(h / 1E3 / g), pad: a.pad })
            };
            a.prototype.generate = function(b) { b = void 0 === b ? {} : b; var c = void 0 === b.timestamp ? Date.now() : b.timestamp; return a.generate({ secret: this.secret, algorithm: this.algorithm, digits: this.digits, period: this.period, timestamp: c, pad: b.pad }) };
            a.validate = function(a) {
                ...
                return b.validate({ token: c, secret: e, algorithm: d, counter: Math.floor(g / 1E3 / h), window: a.window })
            };
            ...
            a.prototype.toString = function() { return C.a.stringify(this) };
            f.b = a
        }, function(l) {
            var f = function() { return this }();
            try { f = f || Function("return this")() || (0, eval)("this") } catch (d) { "object" === typeof window && (f = window) }
            l.exports = f
        }, function(l, f, d) {
            (function(a) {
                var b = d(7),
                ...
                if (c) {
                    ...
                    var C = Buffer.prototype instanceof Uint8Array ? function(a) { return a } : function(a) { for (var b = new Uint8Array(a.length), c = 0; c < b.length; c++) b[c] = a[c]; return b };
                    e.randomBytes = function(a) { return C(c.randomBytes(a)) };
                    e.hmacDigest = function(a, b, e) { return C(c.createHmac(a, h(b)).update(h(e)).digest()) }
                } else {
                    if ("undefined" !== typeof a.crypto && "function" === typeof a.crypto.getRandomValues) var g = function(b) { a.crypto.getRandomValues(b) };
                    else "undefined" !==
                        typeof a.msCrypto && "function" === typeof a.msCrypto.getRandomValues ? g = function(b) { a.msCrypto.getRandomValues(b) } : (console.warn("Cryptography API not available, falling back to 'Math.random'..."), g = function(a) { for (var b = 0; b < a.length; b++) a[b] = Math.floor(256 * Math.random()) });
            ...
            var b = d(0),
                ...
                p = /^\+?[1-9]\d*$/;
            a.parse = function(a) {
                try { var d = decodeURIComponent(a).match(h) } catch (z) {}
                ...
                if ("undefined" !== typeof d.secret && C.test(d.secret)) k.secret = new c.a({ buffer: b.b.b32.encode(d.secret) });
            ...
            var a = d(2);
            d.d(f, "HOTP", function() { return a.a });
            d.d(f, "TOTP", function() { return a.b });
            var b = d(5);
            d.d(f, "URI", function() { return b.a });
            var c = d(1);
            d.d(f, "Secret", function() { return c.a });
            var e = d(0);
            d.d(f, "Utils", function() { return e.b });
            f.version = "3.1.3"
        }, function(l, f) {
            var d = {
                cipher: {},
                ...
                bitArray: {
                    ...
                    extract: function(a, b, c) { var e = Math.floor(-b - c & 31); return ((b + c - 1 ^ b) & -32 ? a[b / 32 | 0] << 32 - e ^ a[b / 32 + 1 | 0] >>> e : a[b / 32 | 0] >>> e) & (1 << c) - 1 },
                    concat: function(a, b) {
                    ...
                    bitLength: function(a) { var b = a.length; return 0 === b ? 0 : 32 * (b - 1) + d.bitArray.getPartial(a[b - 1]) },
                    clamp: function(a, b) {
                        if (32 *
                            a.length < b) return a;
                    ...
                    partial: function(a, b, c) { return 32 === a ? b : (c ? b | 0 : b << 32 - a) + 1099511627776 * a },
            ...
            d.hash.sha1 = function(a) { a ? (this._h = a._h.slice(0), this._buffer = a._buffer.slice(0), this._length = a._length) : this.reset() };
            d.hash.sha1.hash = function(a) { return (new d.hash.sha1).update(a).finalize() };
            d.hash.sha1.prototype = {
                ...
                _S: function(a, b) { return b << a | b >>> 32 - a },
                _block: function(a) {
                    var b, c = this._h;
                    if ("undefined" !== typeof Uint32Array) { var e = Array(80); for (b = 0; 16 > b; b++) e[b] = a[b] } else e = a;
                    var d = c[0];
                    var f = c[1];
                    var g = c[2];
                    var n = c[3];
                    var p = c[4];
                    for (a = 0; 79 >= a; a++) 16 <= a && (e[a] = this._S(1, e[a - 3] ^ e[a - 8] ^ e[a - 14] ^ e[a - 16])), b = this._S(5, d) + this._f(a, f, g, n) + p + e[a] + this._key[Math.floor(a / 20)] | 0, p = n, n = g, g = this._S(30, f), f = d, d = b;
                    c[0] = c[0] + d | 0;
                    c[1] = c[1] + f | 0;
                    c[2] =
                        c[2] + g | 0;
            ...
            d.hash.sha256.hash = function(a) { return (new d.hash.sha256).update(a).finalize() };
            ...
            d.hash.sha512.hash = function(a) { return (new d.hash.sha512).update(a).finalize() };
            d.hash.sha512.prototype = {
                ...
                _precompute: function() {
                    ...
                    function b(a) { return 1099511627776 * (a - Math.floor(a)) & 255 }
                    for (var c =
                            0, d = 2, f, l; 80 > c; d++) {
                        l = !0;
                        for (f = 2; f * f <= d; f++)
                            if (0 === d % f) { l = !1; break }
                        l && (8 > c && (this._init[2 * c] = a(Math.pow(d, .5)), this._init[2 * c + 1] = b(Math.pow(d, .5)) << 24 | this._initr[c]), this._key[2 * c] = a(Math.pow(d, 1 / 3)), this._key[2 * c + 1] = b(Math.pow(d, 1 / 3)) << 24 | this._keyr[c], c++)
                    }
                },
                _block: function(a) {
                    var b = this._h,
